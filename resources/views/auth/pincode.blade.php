...
<div class="form-group mb-5 pb-5">
  <input aria-label="Pincode" id="pincode" type="tel" class="form-control hidden-nunmber form-control-lg rounded-0 text-center text-sm-left" autofocus autocomplete="off" name="pincode" id="pincode">
</div>
</form>
